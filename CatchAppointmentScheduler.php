...
include_once 'CatchCalendarEmail.php';
...
/**
 * Class CatchAppointmentScheduler
 * @package Stanford\CatchAppointmentScheduler
 * @property \CatchCalendarEmail $emailClient
 * @property Client $twilioClient
 * @property  array $instances
 * @property int $eventId
 * @property array $eventInstance
 * @property array $calendarParams
 * @property \Stanford\CatchAppointmentScheduler\Participant $participant
 ...
 */
class CatchAppointmentScheduler extends \ExternalModules\AbstractExternalModule
{
    ...
    /**
     * CatchAppointmentScheduler constructor.
     */
    public function __construct()
    {
        try {
             ...
             */
            $this->setParticipant(new  \Stanford\CatchAppointmentScheduler\Participant());
    ...
    /**
     * @param \CatchCalendarEmail $emailClient
     */
    public function setEmailClient()
    {
        $this->emailClient = new \CatchCalendarEmail;
    }


    /**
     * @return \Stanford\CatchAppointmentScheduler\Participant
     */
    ...
    /**
     * @param \Stanford\CatchAppointmentScheduler\Participant $participant
     */
    ...
    {
        $instance = $this->identifyCurrentInstance($this->getEventId());
        return $instance['show_department'];
    }

    /**
     * @return int
     */
    public function getDefaultSupervisorName()
    {
        $instance = $this->identifyCurrentInstance($this->getEventId());
        return $instance['show_supervisor'];
    }
