...
class Participant
{
    ...
    {
        if ((defined('USERID') && USERID == $sunetId) || CatchAppointmentScheduler::isUserHasManagePermission()) {
            return true;
        }
        return false;
    }
    ...
    {
        $slot = CatchAppointmentScheduler::getSlot($record_id, $event_id, $projectId, $primary);
